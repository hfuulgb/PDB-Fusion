...
ax1 = sns.violinplot(data = df, x = 'model',y = 'MCC',hue="dropout", width=0.7,palette="Set1")

# right plot: box plot
plt.subplot(1, 2, 2)
plt.title("(b) AUC Performence", loc="center")
ax2 = sns.violinplot(data = df, x = 'model', y = 'AUC',hue="dropout",width=0.7,palette="Set1")
