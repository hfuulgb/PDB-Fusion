...
filename="plot-kernel/kernel_ex.csv"
# filename="cnn.csv"
...
ax1 = sns.boxplot(data = df, x = 'model',y = 'MCC',hue="kernel size", width=0.7,palette="Set2")

# right plot: box plot
plt.subplot(1, 2, 2)
plt.title("(b) AUC Performence", loc="center")
ax2 = sns.boxplot(data = df, x = 'model', y = 'AUC',hue="kernel size",width=0.7,palette="Set2")
