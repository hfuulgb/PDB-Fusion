...
ax1 = sns.violinplot(data = df, x = 'CNN_layers',y = 'MCC',hue="Max-length", width=0.7,palette="Set2")

# right plot: box plot
plt.subplot(1, 2, 2)
plt.title("(b) AUC Performence of DBP-CNN", loc="center")
ax2 = sns.violinplot(data = df, x = 'CNN_layers', y = 'AUC',hue="Max-length",width=0.7,palette="Set2")
